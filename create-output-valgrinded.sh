...
# Run this script as `./create-output-valgrinded.sh > output.txt 2>&1`
# This version should provide more info from valgrind
...
if hash valgrind 2>/dev/null; then
  ...
  valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes --log-file="valgrind-output.txt" $EXEC_PROGRAM
...
echo "      ./create-output-valgrinded.sh > output.txt 2>&1 "
echo "====================================================="
